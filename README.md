...
These are not installed by the script (yet...)

- fzf: fuzzy finder when Ctrl+R (`sudo apr install fzf`)
- [Tinty](https://github.com/tinted-theming/tinty): base16 terminal colorscheme manager
